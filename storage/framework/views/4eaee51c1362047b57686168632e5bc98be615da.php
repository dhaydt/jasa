                            ...
                            <ul class="overview-list step-list">
                                <?php if($service_details_for_book->is_service_online !=1): ?>
                                    ...
                                    <li class="list active" id="account">
                                        <a class="list-click" href="javascript:void(0)"> <?php echo e(__('Layanan')); ?></a>
                                    </li>
                                    <li class="list">
                                        <a class="list-click" href="javascript:void(0)"><?php echo e(__('Tanggal & Waktu')); ?></a>
                                    </li>
                                    <li class="list">
                                        <a class="list-click" href="javascript:void(0)"><?php echo e(__('Detail Booking')); ?></a>
                                    </li>
                                    <li class="list">
                                        <a class="list-click" href="javascript:void(0)"><?php echo e(__('Konfirmasi')); ?> </a>
                                    </li>
                                <?php else: ?>
                        ...
                        <!-- Service -->
                            <fieldset class="padding-top-20 padding-bottom-100 confirm-service">
                                <div class="row">
                                    <div class="col-lg-8 margin-top-30">
                                        <div class="service-overview-wrapper padding-bottom-30">
                                            ...
                                            <div class="overview-single padding-top-40">
                                                <h4 class="title"><?php echo e(get_static_option('service_main_attribute_title') ?? __('Apa yang termasuk?')); ?></h4>
                                            ...
                                            <div class="overview-single padding-top-60 extra-services">
                                                <h4 class="title"><?php echo e(get_static_option('service_additional_attribute_title') ?? __('Tingkatkan pesanan Anda dengan tambahan')); ?>
                                            ...
                                            <div class="overview-single padding-top-60">
                                                <h4 class="title"><?php echo e(get_static_option('service_benifits_title') ?? __('Manfaat Paket:')); ?></h4>
                                    ...
                                    <div class="col-lg-4 margin-top-30">
                                        <div class="service-overview-summery">
                                            <h4 class="title"> <?php echo e(get_static_option('service_booking_title') ?? __('Ringkasan pemesanan')); ?> </h4>
                                ...
                                <?php if($service_details_for_book->is_service_online == 1): ?>
                                    <?php if(Auth::guard('web')->check()): ?>
                                        <input type="button" name="next" class="next action-button" value="<?php echo e(__('Berikutnya')); ?>" /> <input
                                                type="button" name="previous" class="previous action-button-previous"
                                                value="<?php echo e(__('Sebelumnya')); ?>" />
                                    <?php else: ?>
                            ...
                            <?php if($service_details_for_book->is_service_online !=1): ?>
                                <fieldset class="padding-top-20 padding-bottom-100 confirm-date-time">
                                    ...
                                    <input type="button" name="next" class="next action-button" value="<?php echo e(__('Berikutnya')); ?>" />
                                    <input type="button" name="previous" class="previous action-button-previous" value="<?php echo e(__('Sebelumnya')); ?>" />
                                </fieldset>
                            <?php endif; ?>
                        <!-- Information -->
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CODE\jasa\resources\views/frontend/pages/services/service-book.blade.php ENDPATH**/ ?>