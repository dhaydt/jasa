                                        ...
                                        <table id="all_order_table" class="custom--table table-td-padding">
                                            ...
                                            <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td data-label="<?php echo e(__('Service Name')); ?>">
                                                        <?php if($order->order_from_job == 'yes'): ?>
                                                            <?php echo e(Str::limit(optional($order->job)->title,20)); ?>

                                                        <?php else: ?>
                                                            <?php echo e(Str::limit(optional($order->service)->title,20)); ?>
