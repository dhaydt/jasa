    ...
    */
    ...
    public function emailVerify(Request $request)
    {
        ...
        try {
            ...
            if (is_null($verify_token)) {
                ...
                $verify_token = rand(1231,7879);
                $user_details->email_verify_token = $verify_token;
                $user_details->phone_verify_token = $verify_token;
                $user_details->save();
    ...
    public function phoneVerify(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            $user_details = User::where(['phone_verify_token' => $request->email_verify_token, 'phone' => $user_details->phone])->first();
        ...
        $verify_token = $user_details->phone_verify_token ?? null;
    ...
    public function resendCode()
    {
        ...
        return redirect()->back()->with(['msg' => __('Kode OTP telah dikirim lagi ke nomer whatsapp anda!'), 'type' => 'success']);
    }
}