                ...
                <form action="{{ route('service.create.order') }}" id="msform" class="msform ms-order-form"
                    ...
                    <ul class="overview-list step-list">
                        ...
                        {{-- <li class="list active" id="account">
                            <a class="list-click" href="javascript:void(0)"> <span class="list-number">1</span>{{
                                __('Location') }}</a>
                        </li> --}}
                        <li class="list active" id="account">
                            <a class="list-click" href="javascript:void(0)"> {{ __('Layanan') }}</a>
                        </li>
                        <li class="list">
                            <a class="list-click" href="javascript:void(0)">{{ __('Tanggal & Waktu') }}</a>
                        </li>
                        <li class="list">
                            <a class="list-click" href="javascript:void(0)">{{ __('Detail Booking') }}</a>
                        </li>
                        <li class="list">
                            <a class="list-click" href="javascript:void(0)">{{ __('Konfirmasi') }} </a>
                        </li>
                        @else
                        ...
                        <li class="list">
                            <a class="list-click" href="javascript:void(0)"> <span class="list-number">2</span>{{
                                __('Information') }}</a>
                        </li>
                        <li class="list">
                    ...
                    {{-- <fieldset class="padding-top-20 padding-bottom-100 confirm-location">
                        <div class="overview-list-all">
                            ...
                            <div class="alert alert-info fade in alert-dismissible show">
                                ...
                                <strong>{{__('Info!')}}</strong> {{__('This service is available only selected country
                                and city')}}
                            </div>
                            ...
                            <div class="overview-location">
                                <div class="single-location active margin-top-30 wow fadeInUp" data-wow-delay=".3s">
                                    ...
                                    <span class="location loacation_add country_name">{{
                                        optional(Auth::guard('web')->user()->country)->country }}</span>
                                    <span class="location loacation_add city_name">{{
                                        optional(Auth::guard('web')->user()->city)->service_city }}</span>
                                    <span class="location loacation_add area_name">{{
                                        optional(Auth::guard('web')->user()->area)->service_area }}</span>
                                ...
                                <div class="select_city_area_country">
                                    <label for="choose_service_city" class="location">{{ __('Service City') }}</label>
                                    <select name="choose_service_city" id="choose_service_city"
                                        class="get_service_city">
                                        @if($service_details_for_book->is_service_all_cities === 1)
                                        @php $cities =
                                        App\ServiceCity::select('id','service_city')->where('country_id',$service_country)->get();
                                        @endphp
                                ...
                                <div class="select_city_area_country">
                                    <label for="choose_service_area" class="location">{{ __('Choose Area') }}</label>
                                        ...
                                        <div class="overview-flex-author">
                                            ...
                                            <div class="overview-contents">
                                                <h4 class="overview-title"> <a
                                                        href="{{ route('service.list.details',$service_details_for_book->slug) }}">{{
                                                        $service_details_for_book->title }}</a>
                                                </h4>
                                            ...
                                            <span class="summery-title">
                                                ...
                                                <ul class='onlilne-special-list '>
                                                    <li><i class="las la-clock"></i> {{ __('Delivery Days').':
                                                        '.$service_details_for_book->delivery_days }}</li>
                                                    <li class="margin-bottom-30"><i class="las la-redo-alt"></i> {{
                                                        __('Revisions').': '.$service_details_for_book->revision }}</li>
                                                </ul>
                                                @endif
                                            </span>
                                            <div class="summery-list-all">
                                                ...
                                                <ul class="summery-result-list">
                                                    <li class="result-list">
                                                        <span class="rooms">
                                                            {{ get_static_option('service_package_fee_title') ??
                                                            __('Package Fee') }}</span>
                                                        <span class="value-count package-fee">{{
                                                            amount_with_currency_symbol($service_details_for_book->price)
                                                            }}</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="single-summery">
                                            ...
                                            <div class="summery-list-all">
                                                ...
                                                <ul class="summery-result-list result-border padding-bottom-20">
                                                    <li class="result-list">
                                                        <span class="rooms">{{ get_static_option('service_extra_title')
                                                ...
                                                <ul class="summery-result-list result-border padding-bottom-20">
                                                    <li class="result-list">
                                                        <span class="rooms">{{
                                                            get_static_option('service_subtotal_title') ??
                                                            __('Subtotal') }}</span>
                                                        <span
                                                ...
                                                <ul class="summery-result-list result-border padding-bottom-20">
                                                    <li class="result-list">
                                                        <span class="rooms"> {{ __('Tax(+)') }} <span
                                                                class="service-tax">{{ optional($country_tax)->tax ??
                                                                0}}</span> %</span>
                                                        <span
                                                ...
                                                <ul class="summery-result-list">
                                                    <li class="result-list">
                                                        <span class="rooms"> <strong>{{
                                                                get_static_option('service_total_amount_title') ??
                                                                __('Total') }}</strong></span>
                                                        <span
                                    ...
                                    <div class="single-date-overview margin-top-30">
                                        ...
                                        <div class="calendar-area margin-top-30">
                                            ...
                                            <ul class="date-time-list margin-top-20 show-date">
                                                <span class="seller-id-for-schedule" style="display:none">{{
                                                    $service_details_for_book->seller_id }}</span>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <fieldset class="padding-top-20 padding-bottom-100 confirm-information">
                        <div class="Info-overview padding-top-30">
                            <h3 class="date-time-title">{{ get_static_option('service_booking_information_title') ??
                                __('Booking Information') }} </h3>
                            <div class="single-info-overview margin-top-30">
                                <div class="single-info-input">
                                    <label class="info-title"> {{ __('Your Name*') }} </label>
                                    <input class="form--control" type="text" name="name" id="name"
                                        placeholder="{{ __('Type Your Name') }}" @if(Auth::guard('web')->check())
                                    value="{{ Auth::user()->name }}" @else value="" @endif>
                                </div>
                                <div class="single-info-input">
                                    <label class="info-title"> {{ __('Your Email*') }} </label>
                                    <input class="form--control" type="email" name="email" id="email"
                                        placeholder="{{ __('Type Your Email') }}" @if(Auth::guard('web')->check())
                            ...
                            <div class="single-info-overview margin-top-30">
                                <div class="single-info-input">
                                    ...
                                    <input class="form--control" type="text" name="phone" id="phone"
                                        placeholder="{{ __('Type Your Number') }}" @if(Auth::guard('web')->check())
                                ...
                                <div class="single-info-input">
                                    ...
                                    <input class="form--control" type="text" name="post_code" id="post_code"
                                        placeholder="{{ __('Type Post Code') }}" @if(Auth::guard('web')->check())
                                    value="{{ Auth::user()->post_code }}" @else value="" @endif>
                                </div>
                            </div>
                            <div class="single-info-overview margin-top-30">
                                <div class="single-info-input">
                                    ...
                                    <input class="form--control" type="text" name="address" id="address"
                                        placeholder="{{ __('Type Your Address') }}" @if(Auth::guard('web')->check())
                                ...
                                <div class="overview-flex-author">
                                    ...
                                    <div class="overview-contents">
                                        <h2 class="overview-title confirm-title"> <a
                                                href="{{ route('service.list.details',$service_details_for_book->slug) }}">{{
                                                $service_details_for_book->title }}</a> </h2>
                                        @if($service_details_for_book->reviews->count() >= 1)
                                        <span class="overview-review"> {{ __('Rating:') }} {{
                                            round(optional($service_details_for_book->reviews)->avg('rating'),1) }}
                                            <b>({{ optional($service_details_for_book->reviews)->count() }})</b>
                                ...
                                <div class="confirm-overview-left margin-top-30">
                                    ...
                                    <div class="single-confirm-overview">
                                        <div class="single-confirm margin-top-30">
                                            ...
                                            @if(Auth::guard('web')->check())
                                            <span class="location details get_area_name">{{
                                                optional(Auth::guard('web')->user()->area)->service_area }}</span>
                                            @else
                                            ...
                                            @if(Auth::guard('web')->check())
                                            <span class="location details get_country_name">{{
                                                optional(Auth::guard('web')->user()->country)->country }}</span>
                                            @else
                                    ...
                                    <div class="overview-summery-contents">
                                                ...
                                                <ul class="summery-list ">
                                                    ...
                                                    <li
                                                        ...
                                                        <span
                                                            ...
                                                            id="include_service_quantity_3_{{ $include->id }}">{{
                                                            $include->include_service_quantity }}</span>
                                                        <span class="room-count">{{
                                                            amount_with_currency_symbol($include->include_service_price)
                                                            }}</span>
                                                        @endif
                                        ...
                                        <div class="single-summery">
                                            ...
                                            <div class="summery-list-all">
                                                ...
                                                <ul class="summery-result-list result-border padding-bottom-20">
                                                    <li class="result-list">
                                                        <span class="rooms"> {{ __('Tax(+)') }} <span>{{
                                                                optional($country_tax)->tax ?? 0}}</span> %</span>
                                                        <span
                                                            class="value-count tax-amount">{{amount_with_currency_symbol(0)}}</span>
                                                    </li>
                                                </ul>
                                                <ul class="summery-result-list">
                                                    <li class="result-list">
                                                        <span class="rooms"> <strong>{{
                                                                get_static_option('service_total_amount_title') ??
                                                                __('Total') }}</strong></span>
                                                        <span class="value-count total-amount total_amount_for_coupon"
                                                ...
                                                <ul class="summery-result-list coupon_input_field">
                                                    <li class="result-list">
                                                        <input type="text" name="coupon_code"
                                                            ...
                                                            placeholder="{{__('Masukan Kode Kupon')}}">
                                                        <button class="apply-coupon">{{ __('Terapkan') }}</button>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="btn-wrapper">
                                            ...
                                            <a class="cmn-btn btn-appoinment btn-bg-1"
                                                ...
                                                In') }}</a>
                                            <small class="text-danger">{{__('Must login to create order for online
                                                services')}}</small>
                                            @endif
                                            @else
                                            {{-- <button type="submit" class="cmn-btn btn-appoinment btn-bg-1">{{
                    ...
                    <div class="container">
                        <div class="signup-wrapper">
                            <div class="signup-contents">
                                <h3 class="signup-title"> {{ get_static_option('login_form_title') ?? __('Sign In') }}
                                </h3>

                                @if(Session::has('msg'))
                                <p class="alert alert-{{Session::get('type') ?? 'success'}}">{{ Session::get('msg') }}
                                </p>
                                @endif
                                ...
                                <div class="social-login-wrapper">
                                    ...
                                    get_static_option('enable_facebook_login'))
                                    <div class="bar-wrap">
                                        <span class="bar"></span>
                                        <p class="or">{{ __('or') }}</p>
                                        <span class="bar"></span>
